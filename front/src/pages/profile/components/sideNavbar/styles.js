...
export const SlidingContainer = styled.div`
  ...
  left: ${({ isHidden }) => isHidden ? `-${slidingEnum.optionsWidth}` : '0'}px;
...
export const OptionsContainer = styled.div`
  ...
  color: white;
  overflow: hidden;
  width: ${({isHidden}) => isHidden ? slidingEnum.optionsWidth : slidingEnum.totalWidth}px;
...
export const ToggleContainer = styled.div`
  ...
  justify-content: center;
  padding-top: 10px;
  width: ${({isHidden}) => isHidden ? slidingEnum.toggleContainerWidth : '0'}px;
  overflow: hidden;
  background: white;
  color: #1976d2;
`;
